...
> **版本**: `v1.0 (2026-03-19)`
> **状态**: `正式有效`
> **范围**: 正式共享文档入口、阅读顺序与冲突优先级；不替代各层正式正文定义。
...
6. 自 `2026-03-19` 起，本文是当前仓库**正式有效**的共享入口索引；各层具体语义仍以对应正式正文为准。
...
3. [CORE_OBJECT_MODEL.md](./CORE_OBJECT_MODEL.md)
4. [EVIDENCE_POLICY_AND_CAUSALITY_GRADES.md](./EVIDENCE_POLICY_AND_CAUSALITY_GRADES.md)
...
2. 本层必须服从第一层的产品定义；
3. 当前实现现实不能反向改写产品定义。
4. 第二层中的设计记录、契约与 ADR 可以记录当前版本实现决策；其中若有内容已被第一层吸收，应以第一层正式文档为准。
